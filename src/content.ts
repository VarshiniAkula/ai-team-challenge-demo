...
export const START = {
  ...
  choices: [
    { route: 'ai_first', label: 'Let the AI check the easy parts first.',
    ...
    { route: 'support_first', label: 'Ask a support teammate to review it.',
    ...
    { route: 'manager_first', label: 'Send it straight to a manager.',
